...
try {
    ...
    $getCheck   = "/sberbank.php?Amount=1100&" . paramStr($paramsCheck) . "&PaymExtId={$extId}&PaymSubjTp={$PaymSubjTp}&RequestId={$requestId}&TermID={$termId}&TermType={$TermType}&function=Check&usr_mail={$usr_mail}&user_ip={$user_ip}&protocol_type=pip";
