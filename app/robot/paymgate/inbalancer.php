...
try {
    ...
    $usr_mail   = "troyka@paymgate.ru";
    $user_ip    = "127.0.0.1";
    $termId     = "TROYKA01"; // "FS001";
...
/**/
    ...
    $step ++;
    $params[$step] = [
        13 => $row["Parameters"]["Next"]["Parameter"][$cntParametr - 1]["Predefined"]["Choice"][3]["@attributes"]["value"],
...
//    var_dump(resultToRow($result));
    ...
    $getCheck   = "/?Amount=24000&" . paramStr($paramsCheck) . "&PaymExtId={$extId}&PaymSubjTp={$PaymSubjTp}&RequestId={$requestId}&TermID={$termId}&TermType=006-22&function=Check&usr_mail={$usr_mail}&user_ip={$user_ip}&protocol_type=pip";
